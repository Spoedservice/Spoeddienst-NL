...
import { Zap, Store, CheckCircle, Phone, ArrowRight, Shield, Clock, Euro } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-[#FF4500] text-white mb-4">Winkel Klusservice</Badge>
              <h1 className="font-heading font-black text-4xl sm:text-5xl text-slate-900 mb-6 leading-tight">
                Winkel Klusservice - <span className="text-[#FF4500]">Altijd Open</span>
              </h1>
              <p className="text-lg text-slate-600 mb-8">
                Uw winkel kan niet dicht. Bij storingen zorgt SpoedDienst24 ervoor dat u zo snel mogelijk weer open kunt. 
            ...
            <div className="hidden lg:block">
              <img 
                ...
                alt="Winkel klusservice - SpoedDienst24 voor retail"
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-6 text-center">
          {[
            { icon: Clock, title: "24/7 Spoed", desc: "Altijd beschikbaar" },
            { icon: Euro, title: "Vaste prijzen", desc: "Transparant" },
            { icon: Shield, title: "Snel ter plaatse", desc: "Minimale omzetverlies" },
            { icon: Store, title: "Retail specialist", desc: "Kennis van winkels" }
          ].map((item, idx) => (
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-heading font-bold text-3xl text-slate-900 mb-8 text-center">Veelvoorkomende winkelklussen</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Inbraakschade herstellen", "Sloten vervangen", "Rolluik repareren",
              "Verlichting installeren", "Stroomstoring oplossen", "Lekkage verhelpen",
              "Beveiliging installeren", "Glazen pui repareren", "Nooduitgang aanpassen"
            ].map((service, idx) => (
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 bg-slate-900 text-center">
        ...
        <p className="text-slate-500 text-sm mt-4">© 2024 SpoedDienst24.nl - Winkel Klusservice</p>
      </footer>
    </div>
  );
}
